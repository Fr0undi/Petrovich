...
class ParserService:
    """Сервис для парсинга товаров с сайта Петрович"""
    ...
    async def start_parsing(self, base_url: str = "https://moscow.petrovich.ru/catalog/"):
        """Запускает полный парсинг сайта"""

        try:
            logger.info("Запуск парсинга Петрович")

...
class Supplier(BaseModel):
    ...
    supplier_name: str = 'Петрович'
    supplier_tel: str = '8 (499) 334-88-88; 8 (499) 334-88-95'
    supplier_address: str = 'г. Москва, ул. Бутырский Вал, д. 68/70 (строение 1), БЦ «Бейкер Плаза», офис 66 (6 этаж)'
